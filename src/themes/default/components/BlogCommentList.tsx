...
import { useBlogComments } from "@/core/hooks/useBlogComments";
import { useCreateBlogComment } from "@/core/hooks/useCreateBlogComment";
import { useUpdateBlogComment } from "@/core/hooks/useUpdateBlogComment";
import { useDeleteBlogComment } from "@/core/hooks/useDeleteBlogComment";
...
function ReplyItem({ reply, slug, onEdit, onDelete, isAuthenticated }: ReplyItemProps) {
...
function CommentItem({ comment, slug, onEdit, onDelete, onReply, isAuthenticated }: CommentItemProps) {
...
export function BlogCommentList({ slug }: BlogCommentListProps) {
  const { isAuthenticated } = useAuth();
  const { data, isLoading, isError } = useBlogComments(slug);
